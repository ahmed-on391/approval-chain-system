...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            $table->unsignedBigInteger($columnNames['permission_foreign_key']);
            ...
            if ($teams) {
                ...
                //     'model_has_permissions_permission_model_type_primary');
                    ...
                    $table->primary([$columnNames['team_foreign_key'], $columnNames['permission_foreign_key'], $columnNames['model_morph_key'], 'model_type'],
                    'model_has_permissions_permission_model_type_primary');
            } else {
                // $table->primary([PermissionRegistrar::$pivotPermission, $columnNames['model_morph_key'], 'model_type'],
                //     'model_has_permissions_permission_model_type_primary');
                                $table->primary([$columnNames['permission_foreign_key'], $columnNames['model_morph_key'], 'model_type'],
                    'model_has_permissions_permission_model_type_primary');
            }
